...
# Configuration
logging.basicConfig(filename='p1_09170920fintune_no_backbone.txt', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
checkpoint_dir = './p1/checkpoints_fintune_full_no_backbone'
os.makedirs(checkpoint_dir, exist_ok=True)
log_file = 'validation_log_no_backbone.csv'
