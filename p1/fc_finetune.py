...
# Configuration
logging.basicConfig(filename='p1_09162152fintune_fc.txt', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
checkpoint_dir = './p1/checkpoints_fintune_fc'
os.makedirs(checkpoint_dir, exist_ok=True)
log_file = 'validation_log_fc.csv'
